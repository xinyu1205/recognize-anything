...
We have combined Tag2Text and RAM with localization models (Grounding-DINO and SAM) to develop a strong and general visual semantic analysis pipeline in the [Grounded-SAM] project (https://github.com/IDEA-Research/Grounded-Segment-Anything).
